...
-- To keep authentication information from being forgotten across different routes and requests. 

1. What does bcrypt do to help us store passwords in a secure manner.

-- Incorporates salts and hashing to encrypt user data for us.

1. What does bcrypt do to slow down attackers?

-- Provides a password hashing function algorithm (Blowfish encryption algorithm) that increases the amount of time a single password can be tested against a specified password space. 
